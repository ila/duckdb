...
public:
	...
	// Constructor.
	FinalReadNode(const size_t index, std::string _child_cte_name, vector<std::string> _child_cte_column_list,
	              vector<std::string> _final_column_list)
	    : TopmostNode(index), child_cte_name(std::move(_child_cte_name)),
...
public:
	...
	// Constructor.
	InsertNode(const size_t index, std::string _target_table, std::string _child_cte_name,
	           const OnConflictAction conflict_action_type)
	    : TopmostNode(index), target_table(std::move(_target_table)), child_cte_name(std::move(_child_cte_name)),
...
public:
	...
	GetNode(const size_t index, vector<std::string> cte_column_names, std::string _catalog, std::string _schema,
	        std::string _table_name, const size_t _table_index, vector<string> _table_filters,
...
public:
	...
	// Constructor.
	FilterNode(const size_t index, vector<std::string> cte_column_names, std::string _child_cte_name,
...
public:
	...
	// Constructor.
	ProjectNode(const size_t index, vector<std::string> cte_column_names, std::string _child_cte_name,
	            vector<std::string> _column_names, const size_t _table_index)
...
public:
	...
	// Constructor.
	AggregateNode(const size_t index, vector<std::string> cte_column_names, std::string _child_cte_name,
	              vector<std::string> _group_names, vector<std::string> _aggregate_names)
...
public:
	...
	// Constructor.
	JoinNode(const size_t index, vector<std::string> cte_column_names, std::string _left_cte_name,
	         std::string _right_cte_name, JoinType _join_type, vector<std::string> _join_conditions)
...
public:
	...
	// Constructor.
	UnionNode(const size_t index, vector<std::string> cte_column_names, std::string _left_cte_name,
	          std::string _right_cte_name, const bool union_all)
