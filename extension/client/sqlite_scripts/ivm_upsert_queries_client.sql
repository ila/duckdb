...
SELECT nickame, city, club,  date, SUM(steps) AS total_steps, _duckdb_ivm_multiplicity
FROM delta_activity_metrics
WHERE _duckdb_ivm_timestamp >= '2025-04-24 09:29:03.284'
GROUP BY nickame, city, club,  date, _duckdb_ivm_multiplicity;
