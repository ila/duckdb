...
create table rdda_table_constraints(table_name varchar references rdda_tables(name), column_name varchar, rdda_randomized bool, rdda_sensitive bool, primary key(table_name, column_name));
